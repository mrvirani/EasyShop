...
import { PROFILE_PAGE } from '../../dummyDataSet/dummydata'
          ...
          <View style={{width:1,height:'40%', borderColor:'white', borderWidth:1}}></View>
            ...
            <View style={styles.walletContainer}>
              <View style={{ textAlign: 'center', flexDirection: 'row' }}>
                ...
                <Image source={require('../../assets/images/Customerfeedback-pana.png')} style={{ width: 50, height: 50, borderRadius: 50, borderColor: 'black', backgroundColor: '#d6baba' }} />
              ...
              <View style={{ textAlign: 'center', flexDirection: 'row', }}>
                ...
                <Image source={require('../../assets/images/Customerfeedback-pana.png')} style={{ width: 50, height: 50, borderRadius: 50, borderColor: 'black', alignItems: 'center', backgroundColor: '#d6baba' }} />
                <View style={{ marginLeft: 10, }}>

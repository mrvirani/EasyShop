...
export const getAddressDetails = () =>{
    ...
    return async dispatch =>{
        ...
        try{
            ...
            dispatch({ type: GET_ADDRESS, resData})
...
export const saveAddress = (type, address, city, state, country, pincode) =>{

    console.log("saveAddresss data log:", type, address, city, state, country, pincode)
        ...
        try{
            ...
            const response = await fetch('https://easyshop-5pbk.onrender.com/userprofile/address',{
                ...
                if (!response.ok) {
                    ...
                    console.log("Error: Received non-200 status code:", response.status);
            ...
            console.log("resdata of saveAddress", resData);

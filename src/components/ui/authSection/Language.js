  ...
  return (
    <View style={styles.screen}>
      ...
      <View style={styles.header}>
        ...
        <MaterialIcons name='keyboard-backspace' color='black' size={25} style={styles.headerIcon} onPress={() => props.navigation.goBack()} />
          ...
          <View style={styles.textContainer}>
            <Text style={styles.title}>Choose Language</Text>
            {
              passdata === "1" ?
                ...
                (<Image source={require('../../../assets/images/eggBlue.png')} style={styles.ovelImage} />)
            }
          </View>
          <Text style={styles.text} numberOfLines={2}>Choose your favorite language to easy to explore app</Text>
        </View>
